	...
	*/
	public function getAdminIndex()
	{
		if (Sentry::hasAnyAccess(['penals_index'])) 
		{
			...
			else return View::make('penals.admin.index');
		} 
	...
	{
		if (Sentry::hasAnyAccess(['penals_create'])) return View::make('penals.admin.create');
		else return Redirect::route('pages.error');
	}
	...
	public function getAdminUpdate($id)
	{
		if (Sentry::hasAnyAccess(['penals_update'])) 
		{
			...
			if (Request::ajax()) return Response::json(['penal' => $penal]);
			else return View::make('penals.admin.edit', ['penal' => $penal]);
		} 
		else return Redirect::route('pages.error');
	}
	...
	*/
	public function getUserIndex()
	{
		if (Sentry::hasAnyAccess(['users'])) 
		{
			...
			else return View::make('penals.user.index');
		} 
		else return Redirect::route('pages.error');
	}
