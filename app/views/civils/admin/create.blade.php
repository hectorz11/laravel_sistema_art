...
@section('content')
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Crear <small>Expediente Civil</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                ...
                <div class="row">
                    {{ Form::open(['route' => 'admin.civils.store']) }}
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label>Nro. de Expediente Civil</label>
                                {{ Form::text('number_civil', Input::old('number_civil'), ['class' => 'form-control', 'placeholder' => 'Nro de Expediente Civil']) }}
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <a href="{{ URL::route('admin.civils.index') }}" class="btn btn-danger"><i class="glyphicon glyphicon-floppy-remove"></i> Cancelar</a>
                        </div>
                    {{ Form::close() }}
                </div>
                <!-- /.row -->
