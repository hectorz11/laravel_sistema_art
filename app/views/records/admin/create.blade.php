                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Crear <small>Registro Civil</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                    ...
                    {{ Form::open(['route' => 'admin.records.store']) }}
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('number_starting', Input::old('number_starting'), ['class' => 'form-control', 'placeholder' => 'Número de Partida']) }}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('interested_m', Input::old('interested_m'), ['class' => 'form-control', 'placeholder' => 'Interesado']) }}
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                {{ Form::text('interested_f', Input::old('interested_f'), ['class' => 'form-control', 'placeholder' => 'Interesada']) }}
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>Partida</label>
                                {{ Form::text('starting', Input::old('starting'), ['class' => 'form-control', 'placeholder' => 'Partida']) }}
                            </div>
